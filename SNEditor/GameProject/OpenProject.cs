...
namespace SNEditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\SNEditor\";
        ...
        public static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.sne\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.sne\Screenshot.png");
        ...
        // CALLED TO OPEN / UPDATE TIME FOR ORGANIZATION
